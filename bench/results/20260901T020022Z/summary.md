...
| mode     | n | recall@1 | recall@5 | MRR    | nDCG@5 |
|----------|---|----------|----------|--------|--------|
| hybrid   | 2 | 0.0000   | 0.0000   | 0.0000 | 0.0000 |
...
|-----------------------------|--------|-----------|---------|
| hybrid recall@5 >= 0.85     | 0.6250 | 0.8500    | FAIL    |
| hybrid MRR >= 0.70          | 0.5417 | 0.7000    | FAIL    |
| hybrid recall@5 >= lexical  | 0.6250 | 0.3750    | PASS    |
| hybrid recall@5 >= semantic | 0.6250 | 0.6250    | PASS    |
| hybrid MRR >= lexical MRR   | 0.5417 | 0.1146    | PASS    |
| hybrid MRR >= semantic MRR  | 0.5417 | 0.5417    | PASS    |
